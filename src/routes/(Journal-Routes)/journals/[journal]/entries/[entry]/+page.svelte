    ...
    async function handleDelete() {
        ...
        try {
            const response = await fetch(
                `/api/journals/${data.journal._id}/entries/${data.entry._id}`,
                {
                    method: 'DELETE',
                },
            );
...
<div class="page-container">
    <header class="page-header">
        ...
        <div class="actions">
            <a
                href="/journals/{data.journal._id}/entries/{data.entry
                    ._id}/edit"
    ...
    {#if showDeleteConfirm}
        <div class="modal-backdrop" onclick={() => (showDeleteConfirm = false)}>
            <div class="modal" onclick={(e) => e.stopPropagation()}>
                <h2>Delete Entry?</h2>
                <p>
                    Are you sure you want to delete "{data.entry.title}"? This
